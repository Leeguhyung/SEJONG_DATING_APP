...
const styles = StyleSheet.create({
  ...
  withdrawSection: { marginTop: 40, alignItems: 'center', paddingHorizontal: 20 },
  withdrawButton: { padding: 10 },
  withdrawButtonText: { color: '#999', fontSize: 14, textDecorationLine: 'underline' },
  withdrawInfoText: { color: '#BBB', fontSize: 12, textAlign: 'center', marginTop: 8, lineHeight: 18 },
